...
const Hero = () => {
  return (
    <div className="w-full h-full bg-[url('./HeroBackground.png')] bg-no-repeat bg-cover flex py-28 text-white">
      <div className="w-full h-full md:max-w-4xl px-4 xl:px-0 xl:max-w-6xl mx-auto md:flex items-center justify-between">
        <div className="flex flex-col gap-[30px] w-full ">
          ...
          <div className="flex gap-[15px]">
            <button className="px-[35px] py-[15px] bg-[#0D082C] rounded-full text-white">
              Get Started
            </button>
            <button className="font-bold px-[35px] py-[15px] rounded-full text-white bg-white flex items-center gap-4 bg-opacity-5">
